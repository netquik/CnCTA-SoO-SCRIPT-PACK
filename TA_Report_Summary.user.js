...
// @updateURL     https://raw.githubusercontent.com/netquik/CnCTA-SoO-SCRIPT-PACK/master/TA_Report_Summary.user.js
// ==/UserScript==
    ...
    function l() {
        ...
        qx.Class.define("ReportSummary.Tool", {
            ...
            members: {
                ...
                ca: function (a) {
                    this.L++;
                    for (var b = Object.keys(ClientLib.Base["EResourceType"]), c = b.length, d = phe.cnc.Util.getDateTimeString(new Date(a.get_Time())), f = [], e = [], h = 1; h < c; h++) {
...
try {
    ...
    ReportSummary_script.textContent = "(" + ReportSummary_main.toString() + ")();";
