          ...
          qx.Class.define("MHTools.OptionsPage", {
            ...
            members: {
              ...
              addPageAbout: function () {
                ...
                page.add(
                  new qx.ui.basic.Label("<b>MHTools</b>").set({
                    rich: true,
                  })
                ); //, textColor: red
                page.add(
                  new qx.ui.basic.Label(
                    "Created: <span style='color:blue'>2012</span>"
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
                ...
                page.add(
                  new qx.ui.basic.Label(
                    "Author: <span style='color:blue'><b>MrHIDEn</b></span>"
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
                ...
                page.add(
                  new qx.ui.basic.Label(
                    "Email: <a href='mailto:mrhiden@outlook.com'>mrhiden@outlook.com</a>"
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
                ...
                page.add(
                  new qx.ui.basic.Label(
                    "Public: <a href='https://userscripts.org/users/471241'>userscripts.org - MrHIDEn</a></br> "
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
                ...
                page.add(
                  new qx.ui.basic.Label("<b>Scripts:</b>").set({
                    rich: true,
                    marginTop: 5,
                  })
                );
                page.add(
                  new qx.ui.basic.Label(
                    "<a href='https://userscripts.org/scripts/show/137978'>Aviable Loot +Info</a>"
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
                ...
                page.add(
                  new qx.ui.basic.Label(
                    "<a href='https://userscripts.org/scripts/show/135806'>Shortcuts +Coords</a>"
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
                ...
                page.add(
                  new qx.ui.basic.Label("<b>Shorten Scripts:</b>").set({
                    rich: true,
                    marginTop: 5,
                  })
                );
                page.add(
                  new qx.ui.basic.Label(
                    "<a href='https://userscripts.org/scripts/show/136743'>Coords 500:500</a>"
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
                ...
                page.add(
                  new qx.ui.basic.Label(
                    "<a href='https://userscripts.org/scripts/show/145657'>Pure Loot summary</a>"
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
                ...
                page.add(
                  new qx.ui.basic.Label(
                    "<a href='https://userscripts.org/scripts/show/137955'>Login x9 + Logout</a>"
                  ).set({
                    rich: true,
                    marginLeft: 10,
                  })
              ...
              extendOptionsWindow: function () {
                ...
                if (!webfrontend.gui.options.OptionsWidget.prototype.baseShow) {
                  webfrontend.gui.options.OptionsWidget.prototype.baseShow =
                    webfrontend.gui.options.OptionsWidget.prototype.show;
                }
                webfrontend.gui.options.OptionsWidget.prototype.show =
                  function () {
                    try {
                      ...
                      console.warn(
                        "MHTools.OptionsPage.extendOptionsWindow: ",
                        e
                      );
                    }
                  };
        ...
        qx.Class.define("MHTools.Loot", {
          ...
          construct: function () {
            ...
            for (var k in this.troopPaths) {
              this.troopImages.push(
                new qx.ui.basic.Image(this.troopPaths[k]).set({
                  Scale: true,
                  Width: 16,
                  Height: 16,
                })
          ...
          members: {
            ...
            lootList: {
              ...
              getIndex: function () {
                ...
                try {
                  var l = this.list.l;
                  var id = ClientLib.Data.MainData.GetInstance()
                    .get_Cities()
                    .get_CurrentCityId();
                  ...
                  for (var i = 0; i < this.list.max; i++) {
                    ...
                    if (l[i].id == id) {
                      ...
                      if (S.get_IsSupported())
                        S.SetItem(this.storeName, this.list);
                      // done
                      return;
                    }
                  }
            ...
            */
            ...
            hmsRT: function (city, type) {
              ...
              var s = city
                .get_CityUnitsData()
                .GetRepairTimeFromEUnitGroup(type, nextLevelFlag);
              var h = Math.floor(s / 3600);
              s %= 3600;
              var m = Math.floor(s / 60);
              s %= 60;
              ...
              try {
                function getKeys(obj, d) {
                  for (var k in obj) {
                    ...
                    if (typeof u.get_UnitLevelRepairRequirements != "function")
                      continue;
                  ...
                  if (typeof d.Keys.Offences != "undefined") {
                    ...
                    ClientLib.Data.City.prototype.kOffenseUnits =
                      d.Keys.Offences;
                    ClientLib.Data.City.prototype.get_OffenseUnits =
                      function () {
                  ...
                  if (typeof d.Keys.Defences != "undefined") {
                    ...
                    ClientLib.Data.City.prototype.kDefenseUnits =
                      d.Keys.Defences;
                    ClientLib.Data.City.prototype.get_DefenseUnits =
                      function () {
            ...
            loadBypass: function (self) {
              try {
                ...
                var ac = ClientLib.Data.MainData.GetInstance()
                  .get_Cities()
                  .get_AllCities().d;
            ...
            loadBase: function () {
              try {
                if (typeof this.Data.lastSelectedBaseId == "undefined")
                  this.Data.lastSelectedBaseId = -1; //, Bypass: {}};

                var d = this.Data;

                d.selectedBaseId = ClientLib.Data.MainData.GetInstance()
                  .get_Cities()
                  .get_CurrentCityId();
                d.selectedOwnBaseId = ClientLib.Data.MainData.GetInstance()
                  .get_Cities()
                  .get_CurrentOwnCityId();
                ...
                if (
                  typeof d.ol == "undefined" ||
                  Object.keys(d.ol).length === 0
                )
                  return false;
                if (
                  typeof d.el == "undefined" ||
                  Object.keys(d.el).length === 0
                )
                  return false;
              ...
              try {
                ...
                for (var j in el.Defences.d) {
                  ...
                  if (this.settings.showTroopsExtra.v) {
                    switch (
                      unit.get_UnitGameData_Obj().mt //keyTroop // TODO check .mt
                    ) {
            ...
            calcInfo: function () {
              ...
              if (this.settings.showInfo.v) {
                try {
                  var ohp = 0,
                    dhp = 0;
                  for (var k in ol.Offences.d)
                    ohp += ol.Offences.d[k].get_Health(); //own of units
                  for (var k in el.Defences.d)
                    dhp += el.Defences.d[k].get_Health(); //ene df units
                  ...
                  t.push(
                    this.numberFormat(
                      ec.get_TotalDefenseHeadCount() /
                        oc.get_TotalOffenseHeadCount(),
                      2
                    )
                  );
              ...
              if (this.settings.showRepairTime.v) {
                try {
                  ...
                  var aa = oc.GetResourceCount(
                    ClientLib.Base.EResourceType.RepairChargeAir
                  );
                  var av = oc.GetResourceCount(
                    ClientLib.Base.EResourceType.RepairChargeVeh
                  );
                  var ai = oc.GetResourceCount(
            ...
            calcFriendlyInfo: function () {
              this.Display.twoLineInfoArrays = [];
              if (
                !this.settings.showLevels.v &&
                !this.settings.showAllyRepairTimeInfo.v
              )
                return;
              ...
              try {
                ...
                if (this.settings.showLevels.v) {
                  ...
                  t = [];
                  if (el.Buildings.c > 0)
                    t.push(this.numberFormat(ec.get_LvlBase(), 2));
                  else t.push("--");
                  if (el.Defences.c > 0)
                    t.push(this.numberFormat(ec.get_LvlDefense(), 2));
                  else t.push("--");
                  if (el.Offences.c > 0)
                    t.push(this.numberFormat(ec.get_LvlOffense(), 2));
                  else t.push("--");
                ...
                if (this.settings.showAllyRepairTimeInfo.v) {
                  ...
                  var aa = ec.GetResourceCount(
                    ClientLib.Base.EResourceType.RepairChargeAir
                  );
                  var av = ec.GetResourceCount(
                    ClientLib.Base.EResourceType.RepairChargeVeh
                  );
                  var ai = ec.GetResourceCount(
                    ClientLib.Base.EResourceType.RepairChargeInf
                  );
                  var am = Math.min(aa, av, ai);
                  ...
                  hp = {};
                  hp.name = IsOwn
                    ? "<b>Repair time (Your offence)</b>"
                    : "<b>Repair time (Ally offence)</b>";
                  hp.lbs = ["Maximum:", "Available:", "Health:", "Level:"];
                  t = [];
                  t.push(this.hms(m));
                  //t.push('---');
            ...
            calcDistance: function () {
              ...
              try {
                ...
                if (visObject != null) {
                  ...
                  var oc = ClientLib.Data.MainData.GetInstance()
                    .get_Cities()
                    .get_CurrentOwnCity();
                  switch (t) {
                    /* RegionCityType
                    ...
                    case ClientLib.Vis.VisObject.EObjectType
                      .RegionPointOfInterest:
                    case ClientLib.Vis.VisObject.EObjectType.RegionRuin:
                      ...
                      var ser =
                        ClientLib.Data.MainData.GetInstance().get_Server();
                      ...
                      var dis = ClientLib.Base.Util.CalculateDistance(
                        ocX,
                        ocY,
                        ecX,
                        ecY
                      );
                      var cen = ClientLib.Base.Util.CalculateDistance(
                        cenX,
                        cenY,
                        ecX,
                        ecY
              ...
              try {
                ...
                if (typeof a != "undefined" && a.length > 0) {
                  for (var i in this.Display.distanceArray) {
                    ...
                    widget.add(
                      new qx.ui.basic.Label(
                        this.Display.distanceArray[i].name
                      ).set({
                        width: 230,
                        rich: true,
                        allowGrowX: true,
                    ...
                    for (var j in this.Display.distanceArray[i].lbs) {
                      widget.add(
                        new qx.ui.basic.Label(
                          this.Display.distanceArray[i].lbs[j]
                        ),
                        {
                          row: r,
                          column: c,
                      ...
                      widget.add(
                        new qx.ui.basic.Label(
                          this.Display.distanceArray[i].val[j]
                        ),
                        {
                          row: r + 1,
                          column: c,
                ...
                if (++this.waiting[0] >= this.waiting.length)
                  this.waiting[0] = 1;
                ...
                widget.add(
                  new qx.ui.basic.Label("Transmission " + w).set({
                    rich: true,
                  }),
                  {
                    row: r++,
              ...
              try {
                ...
                if (this.settings.showLoot.v) {
                  ...
                  if (typeof a != "undefined" && a.length > 0) {
                    ...
                    c = 0;
                    widget.add(
                      new qx.ui.basic.Label(hp.name).set({
                        width: 200,
                        rich: true,
                      }),
                      {
                    ...
                    for (var j in hp.val) {
                      ...
                      widget.add(
                        new qx.ui.basic.Label(this.kMG(hp.val[j])).set({
                          textAlign: "left",
                        }),
                        {
                          row: r,
                ...
                if (this.settings.showTroops.v) {
                  ...
                  if (typeof a != "undefined" && a.length > 0) {
                    ...
                    widget.add(
                      new qx.ui.basic.Label(this.kMG(hp.val[0])).set({
                        textAlign: "left",
                      }),
                      {
                        row: r,
                ...
                if (typeof a != "undefined" && a.length > 0) {
                  for (var i in this.Display.infoArrays) {
                    ...
                    widget.add(
                      new qx.ui.basic.Label(
                        this.Display.infoArrays[i].name
                      ).set({
                        width: 200,
                        rich: true,
                      }),
                    ...
                    for (var j in this.Display.infoArrays[i].lbs) {
                      widget.add(
                        new qx.ui.basic.Label(
                          this.Display.infoArrays[i].lbs[j] +
                            " " +
                            this.Display.infoArrays[i].val[j]
                        ),
                        {
                          row: r,
                          column: c,
                ...
                if (typeof a != "undefined" && a.length > 0) {
                  for (var i in this.Display.twoLineInfoArrays) {
                    ...
                    widget.add(
                      new qx.ui.basic.Label(
                        this.Display.twoLineInfoArrays[i].name
                      ).set({
                        width: 200,
                        rich: true,
                      }),
                    ...
                    for (var j in this.Display.twoLineInfoArrays[i].lbs) {
                      widget.add(
                        new qx.ui.basic.Label(
                          this.Display.twoLineInfoArrays[i].lbs[j]
                        ),
                        {
                          row: r,
                          column: c,
                      ...
                      widget.add(
                        new qx.ui.basic.Label(
                          this.Display.twoLineInfoArrays[i].val[j]
                        ),
                        {
                          row: r + 1,
                          column: c,
            ...
            */
            extendOwnBase: function () {
              ...
              var self = this;
              if (
                !webfrontend.gui.region.RegionCityStatusInfoOwn.prototype
                  .__mhloot_showLootOwnBase
              ) {
                webfrontend.gui.region.RegionCityStatusInfoOwn.prototype.__mhloot_showLootOwnBase =
                ...
                function () {
                  try {
                    if (!self.lootWindowOwn) {
                      self.lootWindowOwn = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowOwn.setTextColor("yellow"); //yellow white

                      var w =
                        webfrontend.gui.region.RegionCityStatusInfoOwn.getInstance();
            ...
            extendAllianceBase: function () {
              ...
              var self = this;
              if (
                !webfrontend.gui.region.RegionCityStatusInfoAlliance.prototype
                  .__mhloot_showLootAllianceBase
              ) {
                webfrontend.gui.region.RegionCityStatusInfoAlliance.prototype.__mhloot_showLootAllianceBase =
                ...
                function () {
                  ...
                  try {
                    ...
                    if (!self.lootWindowAlly) {
                      self.lootWindowAlly = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowAlly.setTextColor("yellow"); //yellow

                      var w =
                        webfrontend.gui.region.RegionCityStatusInfoAlliance.getInstance();
                    ...
                    console.warn(
                      "MHTools.Loot.RegionCityStatusInfoAlliance: ",
                      e
                    );
                  }
            ...
            extendForgottenCamp: function () {
              ...
              var self = this;
              if (
                !webfrontend.gui.region.RegionNPCCampStatusInfo.prototype
                  .__mhloot_showLootNPCCamp
              ) {
                webfrontend.gui.region.RegionNPCCampStatusInfo.prototype.__mhloot_showLootNPCCamp =
                  webfrontend.gui.region.RegionNPCCampStatusInfo.prototype.onCitiesChange;
              }
              webfrontend.gui.region.RegionNPCCampStatusInfo.prototype.onCitiesChange =
                function () {
                  ...
                  try {
                    if (!self.lootWindowCamp) {
                      ...
                      self.lootWindowCamp = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowCamp.setTextColor("white");

                      var widget =
                        webfrontend.gui.region.RegionNPCCampStatusInfo.getInstance();
            ...
            extendForgottenBase: function () {
              ...
              var self = this;
              if (
                !webfrontend.gui.region.RegionNPCBaseStatusInfo.prototype
                  .__mhloot_showLootNPCBase
              ) {
                webfrontend.gui.region.RegionNPCBaseStatusInfo.prototype.__mhloot_showLootNPCBase =
                  webfrontend.gui.region.RegionNPCBaseStatusInfo.prototype.onCitiesChange;
              }
              webfrontend.gui.region.RegionNPCBaseStatusInfo.prototype.onCitiesChange =
                function () {
                  ...
                  try {
                    if (!self.lootWindowBase) {
                      self.lootWindowBase = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowBase.setTextColor("white");

                      var widget =
                        webfrontend.gui.region.RegionNPCBaseStatusInfo.getInstance();
            ...
            extendPlayerBase: function () {
              ...
              var self = this;
              if (
                !webfrontend.gui.region.RegionCityStatusInfoEnemy.prototype
                  .__mhloot_showLootPlayerBase
              ) {
                webfrontend.gui.region.RegionCityStatusInfoEnemy.prototype.__mhloot_showLootPlayerBase =
                ...
                function () {
                  ...
                  try {
                    if (!self.lootWindowPlayer) {
                      self.lootWindowPlayer = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowPlayer.setTextColor("white");

                      var widget =
                        webfrontend.gui.region.RegionCityStatusInfoEnemy.getInstance();
            ...
            extendPOI: function () {
              ...
              if (
                !webfrontend.gui.region.RegionPointOfInterestStatusInfo
                  .prototype.__mhloot_showLootPOI
              ) {
                webfrontend.gui.region.RegionPointOfInterestStatusInfo.prototype.__mhloot_showLootPOI =
                  webfrontend.gui.region.RegionPointOfInterestStatusInfo.prototype.onCitiesChange;
              }
              webfrontend.gui.region.RegionPointOfInterestStatusInfo.prototype.onCitiesChange =
                function () {
                  ...
                  try {
                    if (!self.lootWindowPOI) {
                      self.lootWindowPOI = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowPOI.setTextColor("white");

                      var widget =
                        webfrontend.gui.region.RegionPointOfInterestStatusInfo.getInstance();
                    ...
                    console.warn(
                      "MHTool.Loot.RegionPointOfInterestStatusInfo: ",
                      e
                    );
                  }
            ...
            extendHUB: function () {
              ...
              var self = this;
              if (
                !webfrontend.gui.region.RegionHubStatusInfo.prototype
                  .__mhloot_showLootHUB
              ) {
                webfrontend.gui.region.RegionHubStatusInfo.prototype.__mhloot_showLootHUB =
                  webfrontend.gui.region.RegionHubStatusInfo.prototype.onCitiesChange;
              }
              webfrontend.gui.region.RegionHubStatusInfo.prototype.onCitiesChange =
                function () {
                  ...
                  try {
                    if (!self.lootWindowHUB) {
                      self.lootWindowHUB = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowHUB.setTextColor("white");

                      var widget =
                        webfrontend.gui.region.RegionHubStatusInfo.getInstance();
            ...
            extendHUBServer: function () {
              var self = this;
              if (
                !webfrontend.gui.region.RegionHubServerStatusInfo.prototype
                  .__mhloot_showLootHUB
              ) {
                webfrontend.gui.region.RegionHubServerStatusInfo.prototype.__mhloot_showLootHUB =
                  webfrontend.gui.region.RegionHubServerStatusInfo.prototype.onCitiesChange;
              }
              webfrontend.gui.region.RegionHubServerStatusInfo.prototype.onCitiesChange =
                function () {
                  ...
                  try {
                    if (!self.lootWindowHUBServer) {
                      self.lootWindowHUBServer = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowHUBServer.setTextColor("white");

                      var widget =
                        webfrontend.gui.region.RegionHubServerStatusInfo.getInstance();
            ...
            extendRUIN: function () {
              ...
              var self = this;
              if (
                !webfrontend.gui.region.RegionRuinStatusInfo.prototype
                  .__mhloot_showLootRUIN
              ) {
                webfrontend.gui.region.RegionRuinStatusInfo.prototype.__mhloot_showLootRUIN =
                  webfrontend.gui.region.RegionRuinStatusInfo.prototype.onCitiesChange;
              }
              webfrontend.gui.region.RegionRuinStatusInfo.prototype.onCitiesChange =
                function () {
                  ...
                  try {
                    if (!self.lootWindowRUIN) {
                      self.lootWindowRUIN = new qx.ui.container.Composite(
                        new qx.ui.layout.Grid(5, 5)
                      );
                      self.lootWindowRUIN.setTextColor("white");

                      var widget =
                        webfrontend.gui.region.RegionRuinStatusInfo.getInstance();
            ...
            addLootPage: function () {
              ...
              try {
                ...
                // ...
                this.optionsPage.add(
                  new qx.ui.basic.Label("<b>Options:</b></br>").set({
                    rich: true,
                  })
                ); //, textColor: red
                var i = 0;
                for (var k in this.settings) {
                  this.settings[k].cb = new qx.ui.form.CheckBox(
                    this.settings[k].l
                  ).set({
                    value: this.settings[k].v,
                    paddingLeft: 10,
                  });
                  this.settings[k].cb.addListener(
                    "execute",
                    this.optionsChanged,
                    this
                  );
