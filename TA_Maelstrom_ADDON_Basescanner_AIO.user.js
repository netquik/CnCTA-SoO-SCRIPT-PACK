...
// @contributor NetquiK Sync with Base Scanner Basic code + Layout Scan Modding
// @grant       none
...
(function () {
    var MaelstromTools_Basescanner = function () {
            window.__msbs_version = "1.8.10.2 Plus Infected Camps";
                    ...
                    members: {
                        ...
                        maaain: function (ied) {
                            ...
                            if (fixbld === 1) {
                                ...
                                var optns = [[3, 1, 0.8], [3.5, 1, 0.8], [4, 1, 0.8], [4, 2, 0.3]];
                            }
