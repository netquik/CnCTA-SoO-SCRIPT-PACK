...
//                                    this.getLootFromCurrentCity();
        ...
        function translation() {
            ...
            localeManager.addTranslation("de", {
                ...
                "L": "L",
                "Layout": "Layout",
                "Save/Load/Delete Unit Formations for current city.": "Speichern/Laden/L�schen von Formationen f�r den aktuellen Gegner",
                "Unlock": "Unlock",
                "Unlock Combat Button.": "Entsperrt die Angriffsschaltfl�che.",
                "Unlock Repair Button.": "Entsperrt die Reparaturschaltfl�che.",
                ...
                "Undo's formation to previous saved formation.<br>Save formations by hitting<br>the Update or Simulate button.": "Setzt die Formation auf die vorher gespeicherte zur�ck.<br>Formationen werden gespeichert,<br>wenn man auf Simulieren oder Aktualisieren dr�ckt.",
                "QS": "QS",
                "Saves the current layout<br>without having to open<br>the Formation Saver window.<br>Does not make persistent.": "Speichert die aktuelle Formation,<br>ohne das das Formationsfenster<br>ge�ffnet werden muss.",
                "Back": "zur�ck",
                "Return to Combat Setup.": "Zur�ck zum Angriffsbildschirm.",
                "Updates Simulation Stats.": "Aktualisiert die Statistik.",
                "Buttons:": "Schaltfl�chen:",
                "Right Side": "Rechte Seite",
                "Normal Size": "Normale Gr��e",
                "Disable Repair Button": "Sperre Reparatur-Schaltfl�che",
                "Disable Combat Button": "Sperre Angriffs-Schaltfl�che",
                ...
                "If checked, formation will be saved and can be used by this city in any other city.": "Wenn angew�hlt kann die Formation f�r andere Gegner verwendet werden.",
                "Clear All": "L�sche alle"
            });
        }
