                ...
                qx.Class.define("TABS.STATS", { //				Stats Object
                    ...
                    statics: {
                        ...
                        getPreset: function (num) {
                            switch (num) {
                                case 1:
                                    ...
                                    return {
                                        Name: "CY Only",
                                            Description: "Most priority to construction yard only.<br>After this the best total enemy health from the cached simulations is selected.<br>If no better simulation is found, the best offence unit repair charge and<br>battle duration from the cached simulations is selected.",
                                            Prio: [
                                                [TABS.STATS.Prio.Construction_Yard, TABS.STATS.Type.HealthPointPercentS, false, 0, false],
                                ...
                                case 2:
                                    ...
                                    return {
                                        Name: "DF Only",
                                            Description: "Most priority to defense facility only.<br>After this the best armored defense health from the cached simulations is selected.<br>If no better simulation is found, the best offence unit repair charge and<br>battle duration from the cached simulations is selected.",
                                            Prio: [
                                                [TABS.STATS.Prio.Defense_Facility, TABS.STATS.Type.HealthPointPercentS, false, 0, false],
                                ...
                                case 7:
                                    ...
                                    return {
                                        Name: "CY*",
                                            Description: "NoKill (farming) priority.<br>Not working correctly yet.",
                                            Prio: [
                                                [TABS.STATS.Prio.DefenseArmored, TABS.STATS.Type.HealthPointPercent, false, 0, false],
                                                [TABS.STATS.Prio.Defense_Facility, TABS.STATS.Type.HealthPointPercent, false, 0, false],
                                ...
                                case 8:
                                    return {
                                        Name: "RP",
                                            Description: "Reasearch Points priority",
                                            Prio: [
                                                [TABS.STATS.Prio.ResearchPoints, null, true, 0, false],
                                                [TABS.STATS.Prio.Offense, TABS.STATS.Type.RepairChargeOffense, false, 0, false],
                                                [TABS.STATS.Prio.BattleDuration, null, false, 0, false]
                                            ]
                                    };
                        ...
                        selectPrio: function (stats, prio /*[this.Prio, this.Type, Negate/Boolean, Limit/0.0-1.0/%, NoKill/Boolean]*/ ) {
                            switch (prio[0]) {
                                ...
                                case this.Prio.AutoRepair:
                                    return this._selectType(stats.Enemy.DefenseArmored, prio);
                                case this.Prio.ResearchPoints:
                                    return this._calcRes(ClientLib.Base.EResourceType.ResearchPoints, prio);
                                default:
                        ...
                        _selectType: function (entity, prio) {
                            switch (prio[1]) {
                                case this.Type.HealthPointPercentS:
                                    return entity.HealthPoints.end;
                        ...
                        _calcRes: function (Resource /*{ ClientLib.Base.EResourceType.Tiberium: 1, ClientLib.Base.EResourceType.Crystal: 2, ClientLib.Base.EResourceType.Credits: 3, ClientLib.Base.EResourceType.ResearchPoints: 6 }*/ , prio) {
                            var res = stats.Offense.Overall.Resource[Resource];
                            return res * (prio[2] ? -1 : 1); // Negate
                        },
                ...
                qx.Class.define("TABS.GUI.Window.Stats", { // [singleton]	Stats Window
                    ...
                    members: {
                        ...
                        makeSimView: function () {
                            ...
                            if (this.simViews.length != num && num <= 9) {
                                // MOD LIVE CLONES REMOVE
                                for (i = 0; i < num; i++) {
                ...
                qx.Class.define("TABS.GUI.Window.Stats.SimView", { //				Simulation View Objekt
                    ...
                    construct: function (num, window) {
                        try {
                            ...
                            if (defaultPreset.Name === undefined || defaultPreset.Name !== TABS.STATS.getPreset(num).Name) defaultPreset = TABS.SETTINGS.set("GUI.Window.Stats.SimView." + num, TABS.STATS.getPreset(num));
                            // Reset Settings (if no Name) MOD and if new preset code detected
