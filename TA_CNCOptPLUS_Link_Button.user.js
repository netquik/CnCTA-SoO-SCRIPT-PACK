// ==UserScript==
// @version       1.7.8
// @downloadURL   https://chertosha.com/cncoptbutton.user.js
...
// @updateURL     https://raw.githubusercontent.com/netquik/CnCTA-SoO-SCRIPT-PACK/master/TA_CNCOptPLUS_Link_Button.user.js
// ==/UserScript==
/*
        ...
        var cncopt = {
          ...
          make_sharelink: function () {
            try {
              ...
              var link = "http://chertosha.com/cncoptplus.html??cncoptt=http://cncopt.com/?map=";
              link += "3|"; /* link version */
              ...
              if (PerforceChangelist >= 376877) {
                ...
                for (i = 0; i < defense_unit_list.length; ++i) {
                  unit = defense_unit_list[i];
                  defense_units[unit.get_CoordX()][unit.get_CoordY() + 8] = unit;
                }
              }
             ...
             var  offense_units = []
              ...
              if (PerforceChangelist >= 376877) {
                for (i in offense_unit_list) {
                  unit = offense_unit_list[i];
                  offense_units[unit.get_CoordX()][unit.get_CoordY() + 16] = unit;
                }
              } else {
                for (i = 0; i < offense_unit_list.length; ++i) {
                  unit = offense_unit_list[i];
                  offense_units[unit.get_CoordX()][unit.get_CoordY() + 16] = unit;
                }
              }
