      ...
      webfrontend.gui.region.RegionCityStatusInfoEnemy.prototype.onCitiesChange =
        function () {
          ...
          var city = ClientLib.Data.MainData.GetInstance()
            .get_World()
            .GetObjectFromPosition(selection.get_RawX(), selection.get_RawY());
          var d =
            typeof city.getID != "function"
              ? g.get_Id.toString().match(RE)[1]
              : null;
          if (d)
            city.getID = function () {
              return this[d];
          ...
          if (!widget.hasOwnProperty("offLevel")) {
            var offWidget = new qx.ui.container.Composite(
              new qx.ui.layout.Grid(5, 0)
            );
