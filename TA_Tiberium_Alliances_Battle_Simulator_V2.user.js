            ...
            qx.Class.define("TABS.UTIL.Formation", { // [static]		Utilities for Army Formation
                ...
                statics: {
                    ...
                    GetUnitById: function (id, cityid, ownid) {
                        ...
                        if (units !== null) for (var i = 0; i < units.length; i++)
                ...
                statics: {
                    ...
                    createLink: function (city, own_city) {
                        ...
                        function findTechLayout(city) {
                            for (var k in city)
                            if ((typeof (city[k]) == "object") && city[k] && 0 in city[k] && 8 in city[k]) if ((typeof (city[k][0]) == "object") && city[k][0] && city[k][0] && 0 in city[k][0] && 15 in city[k][0]) if ((typeof (city[k][0][0]) == "object") && city[k][0][0] && "BuildingIndex" in city[k][0][0]) return city[k];
                            return null;
                        }
                        ...
                        function getUnitArrays(city) {
                            var ret = [];
                            for (var k in city)
                            if ((typeof (city[k]) == "object") && city[k]) for (var k2 in city[k])
                            if ((typeof (city[k][k2]) == "object") && city[k][k2] && "d" in city[k][k2]) {
                                var lst = city[k][k2].d;
                                if ((typeof (lst) == "object") && lst) for (var i in lst)
                ...
                members: {
                    ...
                    __validate: function (cityid, ownid, hash) {
                        ...
                        if (ownCity !== null && ownCity.get_Version() !== -1) {
                            ...
                            if (typeof hash == "object" && city.data.recovery != recovery) for (key in city.caches)
                            city.caches[key].valid = false;
                            if (alliance !== null) {
